<x-layouts.app class="mt-6">
    ...
    <section class="grid grid-cols-3 gap-6">
        ...
        <x-cards.action href="{{ route('new-product') }}" icon="package" class="bg-blue-500">{{ __('action.update') }}</x-cards.action>
        <x-cards.action href="{{ route('new-data') }}" icon="table" class="bg-pink-500">{{ __('action.listings') }}</x-cards.action>
